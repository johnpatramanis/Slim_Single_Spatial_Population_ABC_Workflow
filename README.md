...
**Slim_Script.slim**: This file is equally important to the ```Snakemakefile```. This Slim script is spatial (2D) [non-WF simulation model](https://academic.oup.com/mbe/article/36/3/632/5229931).
