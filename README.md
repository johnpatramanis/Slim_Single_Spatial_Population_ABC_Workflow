...
**params.json**: Optional json file. Any parameter defined within this file that matches the name of a parameter in the ```Slim_Script.slim``` will be replaced in the simulation script.
