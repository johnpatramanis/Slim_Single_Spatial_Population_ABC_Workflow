...
for tree_file in os.listdir(F"{Folder}/Spatial_Simulations_SLim.trees/"): ### Find tree file of simulation
    ...
    Random_Sampling = random.sample(Evens, 15) ### Randomly sample 15 unique individuals (sample their 1st haplotype)
    ...
    print(F"Simulation in {Folder}, {Chromosome_Name}, {indiv_index} Individuals had their ancestry assigned! ")        
