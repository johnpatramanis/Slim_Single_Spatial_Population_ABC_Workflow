########### python Python_Scripts/Create_Composite_Individuals_of_an_Ancestry.py ./Simulation_Runs/Simulation_0/Ancestries ./Simulation_Runs/Simulation_0/Composite_Individuals 10
import sys
import os
...
for ANC in Number_of_Maximum_Ancestries_Between_Chromosomes:
    ...
    for CHR in Chromosomes_Individual_Trees.keys():
        ...
        Output_File = open(F'{Output_Folder}/Box_Size_{Size_of_Box}/Ancestry_{ANC}/Composite_Individuals_of_Ancestry_{ANC}_Boxsize_{Size_of_Box}_{CHR}.anc','w')
        ...
        for BOX in BOXES:
            ...
            COMPOSITE_ID = F"Individual_{BOX_X}_{BOX_Y}"
